...
@ManagedBean
@ViewScoped
public class EditInfoInvitadoView implements Serializable{
    ...
    public void init(){
        ...
        if(personal == null || !person.getRol().getRolName().equals("personal")){
            //
            JsfUti.messageError(null, "Error", "El usuario no es del personal de la institución");
            return;
        }
