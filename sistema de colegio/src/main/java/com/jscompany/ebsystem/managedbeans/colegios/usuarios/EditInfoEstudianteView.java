...
@ManagedBean
@ViewScoped
public class EditInfoEstudianteView implements Serializable{
    ...
    public void init(){
        ...
        est = person.getEstudiante();
        if(est == null || !person.getRol().getRolName().equals("estudiante")){
            //
            JsfUti.messageError(null, "Error", "El usuario no es estudiante de la institución");
            return;
        }
