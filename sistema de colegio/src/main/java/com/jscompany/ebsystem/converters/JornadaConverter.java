...
public class JornadaConverter implements Converter, Serializable{
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {        
        if(value==null||value.equals("Seleccionar"))
            ...
            Jornada temp = (Jornada) EntityManagerServices.aclService().getEntity(Jornada.class, Long.parseLong(value));
            return temp;
        }
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {        
        if(value==null||value.equals("Seleccionar"))
            ...
            return ((Jornada)value).getId().toString();        
    } 
